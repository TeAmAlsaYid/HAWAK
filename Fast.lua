...
send(msg.chat_id,msg.id,'\n ≠ علىك الاشتراك في قناة البوت لاستخذام الاوامر\n\n'..chinfo..'')
return false 
end
...
send(msg.chat_id,msg.id,"≠ اهلا بك في صانع بوتات سورس هواك \n≠ قناة السورس @Tii33","html",true, false, false, true, reply_markup)
return false 
end
...
≠ : 2 - ارسل الامر  ‹ newbot/ ›
≠ : 3 - ارسل اسم للبوت كمثال : ‹ Hawks TEaM ›
...
local IdUser_Info = LuaTele.searchPublicChat("Tii33")
...
{
{text = "‹ سورس هواك ›", url="https://t.me/Tii33"},
},
}
...
photo = "https://t.me/ppp4xx/14"
local T =[[
☆︙[𝑊𝐸𝐿𝐶𝑂𝑀𝐸 𝑇𝑂 𝑆𝑂𝑈𝑅𝐶𝐸   ](t.me/Tii33 )
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '• مبرمج السورس •', url = 't.me/Tii33 '},
},
{
{text = '• مطور السورس •', url = 't.me/Tii33'},
},
{
{text = '• قناة التحديثات •', url = 't.me/Tii33 '},
},
{  
{text = '• 𝑆𝑂𝑈𝑅𝐶𝐸  •', url = 't.me/Tii33 '},
},
}
